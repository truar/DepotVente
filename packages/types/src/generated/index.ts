...
export const CashRegisterControlScalarFieldEnumSchema = z.enum(['id','cashRegisterId','type','initialAmount','theoreticalCashAmount','realCashAmount','difference','totalAmount','cash200','cash100','cash50','cash20','cash10','cash5','cash2','cash1','cash05','cash02','cash01','cash005','cash002','cash001','comment','createdAt','updatedAt','deletedAt']);
...
export const DepositScalarFieldEnumSchema = z.enum(['id','sellerId','contributionStatus','contributionAmount','depositIndex','incrementStart','dropWorkstationId','type','returnedCalculationDate','soldAmount','clubAmount','dueContributionAmount','sellerAmount','collectWorkstationId','contributionCollectWorkstationId','collectedAt','checkId','signatory','createdAt','updatedAt','deletedAt']);

export const SaleScalarFieldEnumSchema = z.enum(['id','buyerId','saleIndex','incrementStart','cardAmount','cashAmount','checkAmount','deferredAmount','totalRefundAmount','createdAt','updatedAt','deletedAt']);

export const RefundScalarFieldEnumSchema = z.enum(['id','saleId','incrementStart','cardAmount','cashAmount','comment','createdAt','updatedAt','deletedAt']);

export const ArticleScalarFieldEnumSchema = z.enum(['id','price','category','discipline','brand','model','serialNumber','size','color','code','year','depositIndex','identificationLetter','articleIndex','status','depositId','saleId','createdAt','updatedAt','deletedAt']);
...
/////////////////////////////////////////
// CASH REGISTER CONTROL SCHEMA
/////////////////////////////////////////

export const CashRegisterControlSchema = z.object({
  id: z.uuid(),
  cashRegisterId: z.number().int(),
  type: z.string(),
  initialAmount: z.instanceof(Prisma.Decimal, { message: "Field 'initialAmount' must be a Decimal. Location: ['Models', 'CashRegisterControl']"}),
  theoreticalCashAmount: z.instanceof(Prisma.Decimal, { message: "Field 'theoreticalCashAmount' must be a Decimal. Location: ['Models', 'CashRegisterControl']"}),
  realCashAmount: z.instanceof(Prisma.Decimal, { message: "Field 'realCashAmount' must be a Decimal. Location: ['Models', 'CashRegisterControl']"}),
  difference: z.instanceof(Prisma.Decimal, { message: "Field 'difference' must be a Decimal. Location: ['Models', 'CashRegisterControl']"}),
  totalAmount: z.instanceof(Prisma.Decimal, { message: "Field 'totalAmount' must be a Decimal. Location: ['Models', 'CashRegisterControl']"}),
  cash200: z.number().int(),
  cash100: z.number().int(),
  cash50: z.number().int(),
  cash20: z.number().int(),
  cash10: z.number().int(),
  cash5: z.number().int(),
  ...
  cash02: z.number().int(),
  cash01: z.number().int(),
  cash005: z.number().int(),
  cash002: z.number().int(),
  cash001: z.number().int(),
...
export type CashRegisterControl = z.infer<typeof CashRegisterControlSchema>
...
export const DepositSchema = z.object({
  ...
  contributionCollectWorkstationId: z.number().int().nullable(),
...
export const SaleSchema = z.object({
  ...
  deferredAmount: z.instanceof(Prisma.Decimal, { message: "Field 'deferredAmount' must be a Decimal. Location: ['Models', 'Sale']"}),
  totalRefundAmount: z.instanceof(Prisma.Decimal, { message: "Field 'totalRefundAmount' must be a Decimal. Location: ['Models', 'Sale']"}),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  deletedAt: z.coerce.date().nullable(),
})
...
export const RefundSchema = z.object({
  ...
  saleId: z.string(),
  incrementStart: z.number().int(),
  cardAmount: z.instanceof(Prisma.Decimal, { message: "Field 'cardAmount' must be a Decimal. Location: ['Models', 'Refund']"}),
  cashAmount: z.instanceof(Prisma.Decimal, { message: "Field 'cashAmount' must be a Decimal. Location: ['Models', 'Refund']"}),
  comment: z.string(),
  createdAt: z.coerce.date(),
  updatedAt: z.coerce.date(),
  deletedAt: z.coerce.date().nullable(),
...
export const CashRegisterControlSelectSchema: z.ZodType<Prisma.CashRegisterControlSelect> = z.object({
  id: z.boolean().optional(),
  cashRegisterId: z.boolean().optional(),
  type: z.boolean().optional(),
  initialAmount: z.boolean().optional(),
  theoreticalCashAmount: z.boolean().optional(),
  realCashAmount: z.boolean().optional(),
  difference: z.boolean().optional(),
  totalAmount: z.boolean().optional(),
  cash200: z.boolean().optional(),
  cash100: z.boolean().optional(),
  cash50: z.boolean().optional(),
  cash20: z.boolean().optional(),
  cash10: z.boolean().optional(),
  cash5: z.boolean().optional(),
  cash2: z.boolean().optional(),
  cash1: z.boolean().optional(),
  cash05: z.boolean().optional(),
  cash02: z.boolean().optional(),
  cash01: z.boolean().optional(),
  cash005: z.boolean().optional(),
  cash002: z.boolean().optional(),
  cash001: z.boolean().optional(),
...
export const DepositSelectSchema: z.ZodType<Prisma.DepositSelect> = z.object({
  ...
  contributionCollectWorkstationId: z.boolean().optional(),
...
export const SaleIncludeSchema: z.ZodType<Prisma.SaleInclude> = z.object({
  ...
  articles: z.union([z.boolean(),z.lazy(() => ArticleFindManyArgsSchema)]).optional(),
  refunds: z.union([z.boolean(),z.lazy(() => RefundFindManyArgsSchema)]).optional(),
...
export const SaleSelectSchema: z.ZodType<Prisma.SaleSelect> = z.object({
  ...
  deferredAmount: z.boolean().optional(),
  totalRefundAmount: z.boolean().optional(),
  createdAt: z.boolean().optional(),
  updatedAt: z.boolean().optional(),
  deletedAt: z.boolean().optional(),
  buyer: z.union([z.boolean(),z.lazy(() => ContactArgsSchema)]).optional(),
...
export const RefundIncludeSchema: z.ZodType<Prisma.RefundInclude> = z.object({
  sale: z.union([z.boolean(),z.lazy(() => SaleArgsSchema)]).optional(),
}).strict();

export const RefundArgsSchema: z.ZodType<Prisma.RefundDefaultArgs> = z.object({
  select: z.lazy(() => RefundSelectSchema).optional(),
  include: z.lazy(() => RefundIncludeSchema).optional(),
}).strict();

export const RefundSelectSchema: z.ZodType<Prisma.RefundSelect> = z.object({
  id: z.boolean().optional(),
...
export const CashRegisterControlWhereInputSchema: z.ZodType<Prisma.CashRegisterControlWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => CashRegisterControlWhereInputSchema), z.lazy(() => CashRegisterControlWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => CashRegisterControlWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => CashRegisterControlWhereInputSchema), z.lazy(() => CashRegisterControlWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => UuidFilterSchema), z.string() ]).optional(),
  cashRegisterId: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  type: z.union([ z.lazy(() => StringFilterSchema), z.string() ]).optional(),
  initialAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  theoreticalCashAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  realCashAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  difference: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  ...
  cash200: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash100: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash50: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash20: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash10: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash5: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash2: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash1: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash05: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash02: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash01: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash005: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash002: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cash001: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
...
export const CashRegisterControlOrderByWithRelationInputSchema: z.ZodType<Prisma.CashRegisterControlOrderByWithRelationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  type: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
  theoreticalCashAmount: z.lazy(() => SortOrderSchema).optional(),
  realCashAmount: z.lazy(() => SortOrderSchema).optional(),
  difference: z.lazy(() => SortOrderSchema).optional(),
  totalAmount: z.lazy(() => SortOrderSchema).optional(),
  cash200: z.lazy(() => SortOrderSchema).optional(),
  cash100: z.lazy(() => SortOrderSchema).optional(),
  cash50: z.lazy(() => SortOrderSchema).optional(),
  cash20: z.lazy(() => SortOrderSchema).optional(),
  cash10: z.lazy(() => SortOrderSchema).optional(),
  cash5: z.lazy(() => SortOrderSchema).optional(),
  cash2: z.lazy(() => SortOrderSchema).optional(),
  cash1: z.lazy(() => SortOrderSchema).optional(),
  cash05: z.lazy(() => SortOrderSchema).optional(),
  cash02: z.lazy(() => SortOrderSchema).optional(),
  cash01: z.lazy(() => SortOrderSchema).optional(),
  cash005: z.lazy(() => SortOrderSchema).optional(),
  cash002: z.lazy(() => SortOrderSchema).optional(),
  cash001: z.lazy(() => SortOrderSchema).optional(),
...
export const CashRegisterControlWhereUniqueInputSchema: z.ZodType<Prisma.CashRegisterControlWhereUniqueInput> = z.object({
  id: z.uuid(),
})
.and(z.strictObject({
  id: z.uuid().optional(),
  ...
  OR: z.lazy(() => CashRegisterControlWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => CashRegisterControlWhereInputSchema), z.lazy(() => CashRegisterControlWhereInputSchema).array() ]).optional(),
  cashRegisterId: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  type: z.union([ z.lazy(() => StringFilterSchema), z.string() ]).optional(),
  initialAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  theoreticalCashAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  realCashAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  difference: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  totalAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  cash200: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash100: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash50: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash20: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash10: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash5: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash2: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash1: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash05: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash02: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash01: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash005: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash002: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  cash001: z.union([ z.lazy(() => IntFilterSchema), z.number().int() ]).optional(),
  comment: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema), z.coerce.date() ]).optional().nullable(),
...
export const CashRegisterControlOrderByWithAggregationInputSchema: z.ZodType<Prisma.CashRegisterControlOrderByWithAggregationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  type: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
  ...
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  deletedAt: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
  _count: z.lazy(() => CashRegisterControlCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => CashRegisterControlAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => CashRegisterControlMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => CashRegisterControlMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => CashRegisterControlSumOrderByAggregateInputSchema).optional(),
});

export const CashRegisterControlScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.CashRegisterControlScalarWhereWithAggregatesInput> = z.strictObject({
  AND: z.union([ z.lazy(() => CashRegisterControlScalarWhereWithAggregatesInputSchema), z.lazy(() => CashRegisterControlScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => CashRegisterControlScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => CashRegisterControlScalarWhereWithAggregatesInputSchema), z.lazy(() => CashRegisterControlScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema), z.string() ]).optional(),
  cashRegisterId: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  type: z.union([ z.lazy(() => StringWithAggregatesFilterSchema), z.string() ]).optional(),
  initialAmount: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  theoreticalCashAmount: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  realCashAmount: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  difference: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  ...
  cash200: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash100: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash50: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash20: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash10: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash5: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash2: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash1: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash05: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash02: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash01: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash005: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash002: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
  cash001: z.union([ z.lazy(() => IntWithAggregatesFilterSchema), z.number() ]).optional(),
...
export const DepositWhereInputSchema: z.ZodType<Prisma.DepositWhereInput> = z.strictObject({
  ...
  contributionStatus: z.union([ z.lazy(() => StringFilterSchema), z.string() ]).optional(),
  ...
  contributionCollectWorkstationId: z.union([ z.lazy(() => IntNullableFilterSchema), z.number() ]).optional().nullable(),
...
export const DepositOrderByWithRelationInputSchema: z.ZodType<Prisma.DepositOrderByWithRelationInput> = z.strictObject({
  ...
  contributionCollectWorkstationId: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
...
.and(z.strictObject({
  ...
  contributionCollectWorkstationId: z.union([ z.lazy(() => IntNullableFilterSchema), z.number().int() ]).optional().nullable(),
  collectedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema), z.coerce.date() ]).optional().nullable(),
  checkId: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  signatory: z.union([ z.lazy(() => StringNullableFilterSchema), z.string() ]).optional().nullable(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
...
export const DepositScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.DepositScalarWhereWithAggregatesInput> = z.strictObject({
  ...
  contributionStatus: z.union([ z.lazy(() => StringWithAggregatesFilterSchema), z.string() ]).optional(),
  ...
  contributionCollectWorkstationId: z.union([ z.lazy(() => IntNullableWithAggregatesFilterSchema), z.number() ]).optional().nullable(),
...
export const SaleWhereInputSchema: z.ZodType<Prisma.SaleWhereInput> = z.strictObject({
  ...
  deferredAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  totalRefundAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeFilterSchema), z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableFilterSchema), z.coerce.date() ]).optional().nullable(),
  buyer: z.union([ z.lazy(() => ContactScalarRelationFilterSchema), z.lazy(() => ContactWhereInputSchema) ]).optional(),
  articles: z.lazy(() => ArticleListRelationFilterSchema).optional(),
  refunds: z.lazy(() => RefundListRelationFilterSchema).optional(),
});
...
export const SaleOrderByWithRelationInputSchema: z.ZodType<Prisma.SaleOrderByWithRelationInput> = z.strictObject({
  ...
  deferredAmount: z.lazy(() => SortOrderSchema).optional(),
  totalRefundAmount: z.lazy(() => SortOrderSchema).optional(),
  createdAt: z.lazy(() => SortOrderSchema).optional(),
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  deletedAt: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
  buyer: z.lazy(() => ContactOrderByWithRelationInputSchema).optional(),
  articles: z.lazy(() => ArticleOrderByRelationAggregateInputSchema).optional(),
  refunds: z.lazy(() => RefundOrderByRelationAggregateInputSchema).optional(),
});
...
export const SaleScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.SaleScalarWhereWithAggregatesInput> = z.strictObject({
  ...
  deferredAmount: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  totalRefundAmount: z.union([ z.lazy(() => DecimalWithAggregatesFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
  createdAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema), z.coerce.date() ]).optional(),
  updatedAt: z.union([ z.lazy(() => DateTimeWithAggregatesFilterSchema), z.coerce.date() ]).optional(),
  deletedAt: z.union([ z.lazy(() => DateTimeNullableWithAggregatesFilterSchema), z.coerce.date() ]).optional().nullable(),
});

export const RefundWhereInputSchema: z.ZodType<Prisma.RefundWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => RefundWhereInputSchema), z.lazy(() => RefundWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => RefundWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => RefundWhereInputSchema), z.lazy(() => RefundWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => UuidFilterSchema), z.string() ]).optional(),
...
export const RefundOrderByWithRelationInputSchema: z.ZodType<Prisma.RefundOrderByWithRelationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
...
export const RefundWhereUniqueInputSchema: z.ZodType<Prisma.RefundWhereUniqueInput> = z.object({
  id: z.uuid(),
})
.and(z.strictObject({
  id: z.uuid().optional(),
...
export const RefundOrderByWithAggregationInputSchema: z.ZodType<Prisma.RefundOrderByWithAggregationInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  saleId: z.lazy(() => SortOrderSchema).optional(),
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
  ...
  updatedAt: z.lazy(() => SortOrderSchema).optional(),
  deletedAt: z.union([ z.lazy(() => SortOrderSchema), z.lazy(() => SortOrderInputSchema) ]).optional(),
  _count: z.lazy(() => RefundCountOrderByAggregateInputSchema).optional(),
  _avg: z.lazy(() => RefundAvgOrderByAggregateInputSchema).optional(),
  _max: z.lazy(() => RefundMaxOrderByAggregateInputSchema).optional(),
  _min: z.lazy(() => RefundMinOrderByAggregateInputSchema).optional(),
  _sum: z.lazy(() => RefundSumOrderByAggregateInputSchema).optional(),
});

export const RefundScalarWhereWithAggregatesInputSchema: z.ZodType<Prisma.RefundScalarWhereWithAggregatesInput> = z.strictObject({
  AND: z.union([ z.lazy(() => RefundScalarWhereWithAggregatesInputSchema), z.lazy(() => RefundScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  OR: z.lazy(() => RefundScalarWhereWithAggregatesInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => RefundScalarWhereWithAggregatesInputSchema), z.lazy(() => RefundScalarWhereWithAggregatesInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => UuidWithAggregatesFilterSchema), z.string() ]).optional(),
...
export const CashRegisterControlCreateInputSchema: z.ZodType<Prisma.CashRegisterControlCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  cashRegisterId: z.number().int(),
  type: z.string(),
  initialAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  theoreticalCashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  realCashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
  difference: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
...
export const CashRegisterControlUncheckedCreateInputSchema: z.ZodType<Prisma.CashRegisterControlUncheckedCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  cashRegisterId: z.number().int(),
  type: z.string(),
  initialAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
...
export const CashRegisterControlUpdateInputSchema: z.ZodType<Prisma.CashRegisterControlUpdateInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  cashRegisterId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  initialAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  theoreticalCashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  realCashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  difference: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  cash200: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash100: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash50: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash20: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash10: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash5: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash2: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash1: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash05: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash02: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash01: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash005: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash002: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cash001: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CashRegisterControlUncheckedUpdateInputSchema: z.ZodType<Prisma.CashRegisterControlUncheckedUpdateInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  cashRegisterId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  initialAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CashRegisterControlCreateManyInputSchema: z.ZodType<Prisma.CashRegisterControlCreateManyInput> = z.strictObject({
  id: z.uuid().optional(),
  cashRegisterId: z.number().int(),
  type: z.string(),
  initialAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),
...
export const CashRegisterControlUpdateManyMutationInputSchema: z.ZodType<Prisma.CashRegisterControlUpdateManyMutationInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  cashRegisterId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  initialAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CashRegisterControlUncheckedUpdateManyInputSchema: z.ZodType<Prisma.CashRegisterControlUncheckedUpdateManyInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  cashRegisterId: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  type: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  initialAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const DepositCreateInputSchema: z.ZodType<Prisma.DepositCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  contributionStatus: z.string().optional(),
  ...
  contributionCollectWorkstationId: z.number().int().optional().nullable(),
...
export const DepositUpdateInputSchema: z.ZodType<Prisma.DepositUpdateInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  contributionStatus: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  contributionCollectWorkstationId: z.union([ z.number().int(),z.lazy(() => NullableIntFieldUpdateOperationsInputSchema) ]).optional().nullable(),
...
export const SaleCreateInputSchema: z.ZodType<Prisma.SaleCreateInput> = z.strictObject({
  ...
  deferredAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  totalRefundAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  createdAt: z.coerce.date().optional(),
  updatedAt: z.coerce.date().optional(),
  deletedAt: z.coerce.date().optional().nullable(),
  ...
  refunds: z.lazy(() => RefundCreateNestedManyWithoutSaleInputSchema).optional(),
});
...
export const SaleUncheckedCreateInputSchema: z.ZodType<Prisma.SaleUncheckedCreateInput> = z.strictObject({
  ...
  refunds: z.lazy(() => RefundUncheckedCreateNestedManyWithoutSaleInputSchema).optional(),
});
...
export const SaleUpdateInputSchema: z.ZodType<Prisma.SaleUpdateInput> = z.strictObject({
  ...
  deferredAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  totalRefundAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  createdAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  deletedAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  ...
  refunds: z.lazy(() => RefundUpdateManyWithoutSaleNestedInputSchema).optional(),
});
...
export const SaleUncheckedUpdateInputSchema: z.ZodType<Prisma.SaleUncheckedUpdateInput> = z.strictObject({
  ...
  refunds: z.lazy(() => RefundUncheckedUpdateManyWithoutSaleNestedInputSchema).optional(),
});
...
export const RefundCreateInputSchema: z.ZodType<Prisma.RefundCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  cashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  ...
  updatedAt: z.coerce.date().optional(),
  deletedAt: z.coerce.date().optional().nullable(),
  sale: z.lazy(() => SaleCreateNestedOneWithoutRefundsInputSchema),
});

export const RefundUncheckedCreateInputSchema: z.ZodType<Prisma.RefundUncheckedCreateInput> = z.strictObject({
  id: z.uuid().optional(),
  saleId: z.string(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const RefundUpdateInputSchema: z.ZodType<Prisma.RefundUpdateInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  cashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  ...
  updatedAt: z.union([ z.coerce.date(),z.lazy(() => DateTimeFieldUpdateOperationsInputSchema) ]).optional(),
  deletedAt: z.union([ z.coerce.date(),z.lazy(() => NullableDateTimeFieldUpdateOperationsInputSchema) ]).optional().nullable(),
  sale: z.lazy(() => SaleUpdateOneRequiredWithoutRefundsNestedInputSchema).optional(),
});

export const RefundUncheckedUpdateInputSchema: z.ZodType<Prisma.RefundUncheckedUpdateInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RefundCreateManyInputSchema: z.ZodType<Prisma.RefundCreateManyInput> = z.strictObject({
  id: z.uuid().optional(),
  saleId: z.string(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const RefundUpdateManyMutationInputSchema: z.ZodType<Prisma.RefundUpdateManyMutationInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  cashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RefundUncheckedUpdateManyInputSchema: z.ZodType<Prisma.RefundUncheckedUpdateManyInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  saleId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CashRegisterControlCountOrderByAggregateInputSchema: z.ZodType<Prisma.CashRegisterControlCountOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  type: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const CashRegisterControlAvgOrderByAggregateInputSchema: z.ZodType<Prisma.CashRegisterControlAvgOrderByAggregateInput> = z.strictObject({
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
  theoreticalCashAmount: z.lazy(() => SortOrderSchema).optional(),
  realCashAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const CashRegisterControlMaxOrderByAggregateInputSchema: z.ZodType<Prisma.CashRegisterControlMaxOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  type: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const CashRegisterControlMinOrderByAggregateInputSchema: z.ZodType<Prisma.CashRegisterControlMinOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  type: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const CashRegisterControlSumOrderByAggregateInputSchema: z.ZodType<Prisma.CashRegisterControlSumOrderByAggregateInput> = z.strictObject({
  cashRegisterId: z.lazy(() => SortOrderSchema).optional(),
  initialAmount: z.lazy(() => SortOrderSchema).optional(),
  theoreticalCashAmount: z.lazy(() => SortOrderSchema).optional(),
  realCashAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const DepositCountOrderByAggregateInputSchema: z.ZodType<Prisma.DepositCountOrderByAggregateInput> = z.strictObject({
  ...
  contributionCollectWorkstationId: z.lazy(() => SortOrderSchema).optional(),
...
export const RefundListRelationFilterSchema: z.ZodType<Prisma.RefundListRelationFilter> = z.strictObject({
  every: z.lazy(() => RefundWhereInputSchema).optional(),
  some: z.lazy(() => RefundWhereInputSchema).optional(),
  none: z.lazy(() => RefundWhereInputSchema).optional(),
});

export const RefundOrderByRelationAggregateInputSchema: z.ZodType<Prisma.RefundOrderByRelationAggregateInput> = z.strictObject({
  _count: z.lazy(() => SortOrderSchema).optional(),
});
...
export const RefundCountOrderByAggregateInputSchema: z.ZodType<Prisma.RefundCountOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  saleId: z.lazy(() => SortOrderSchema).optional(),
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const RefundAvgOrderByAggregateInputSchema: z.ZodType<Prisma.RefundAvgOrderByAggregateInput> = z.strictObject({
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
  cashAmount: z.lazy(() => SortOrderSchema).optional(),
});

export const RefundMaxOrderByAggregateInputSchema: z.ZodType<Prisma.RefundMaxOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  saleId: z.lazy(() => SortOrderSchema).optional(),
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const RefundMinOrderByAggregateInputSchema: z.ZodType<Prisma.RefundMinOrderByAggregateInput> = z.strictObject({
  id: z.lazy(() => SortOrderSchema).optional(),
  saleId: z.lazy(() => SortOrderSchema).optional(),
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
...
export const RefundSumOrderByAggregateInputSchema: z.ZodType<Prisma.RefundSumOrderByAggregateInput> = z.strictObject({
  incrementStart: z.lazy(() => SortOrderSchema).optional(),
  cardAmount: z.lazy(() => SortOrderSchema).optional(),
  cashAmount: z.lazy(() => SortOrderSchema).optional(),
});
...
export const RefundCreateNestedManyWithoutSaleInputSchema: z.ZodType<Prisma.RefundCreateNestedManyWithoutSaleInput> = z.strictObject({
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundCreateWithoutSaleInputSchema).array(), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema), z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RefundCreateManySaleInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
});
...
export const RefundUncheckedCreateNestedManyWithoutSaleInputSchema: z.ZodType<Prisma.RefundUncheckedCreateNestedManyWithoutSaleInput> = z.strictObject({
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundCreateWithoutSaleInputSchema).array(), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema), z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RefundCreateManySaleInputEnvelopeSchema).optional(),
  connect: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
...
export const RefundUpdateManyWithoutSaleNestedInputSchema: z.ZodType<Prisma.RefundUpdateManyWithoutSaleNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundCreateWithoutSaleInputSchema).array(), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema), z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RefundUpsertWithWhereUniqueWithoutSaleInputSchema), z.lazy(() => RefundUpsertWithWhereUniqueWithoutSaleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RefundCreateManySaleInputEnvelopeSchema).optional(),
  set: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
  disconnect: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
  delete: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
  connect: z.union([ z.lazy(() => RefundWhereUniqueInputSchema), z.lazy(() => RefundWhereUniqueInputSchema).array() ]).optional(),
  update: z.union([ z.lazy(() => RefundUpdateWithWhereUniqueWithoutSaleInputSchema), z.lazy(() => RefundUpdateWithWhereUniqueWithoutSaleInputSchema).array() ]).optional(),
  updateMany: z.union([ z.lazy(() => RefundUpdateManyWithWhereWithoutSaleInputSchema), z.lazy(() => RefundUpdateManyWithWhereWithoutSaleInputSchema).array() ]).optional(),
  deleteMany: z.union([ z.lazy(() => RefundScalarWhereInputSchema), z.lazy(() => RefundScalarWhereInputSchema).array() ]).optional(),
});
...
export const RefundUncheckedUpdateManyWithoutSaleNestedInputSchema: z.ZodType<Prisma.RefundUncheckedUpdateManyWithoutSaleNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundCreateWithoutSaleInputSchema).array(), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema).array() ]).optional(),
  connectOrCreate: z.union([ z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema), z.lazy(() => RefundCreateOrConnectWithoutSaleInputSchema).array() ]).optional(),
  upsert: z.union([ z.lazy(() => RefundUpsertWithWhereUniqueWithoutSaleInputSchema), z.lazy(() => RefundUpsertWithWhereUniqueWithoutSaleInputSchema).array() ]).optional(),
  createMany: z.lazy(() => RefundCreateManySaleInputEnvelopeSchema).optional(),
...
export const SaleCreateNestedOneWithoutRefundsInputSchema: z.ZodType<Prisma.SaleCreateNestedOneWithoutRefundsInput> = z.strictObject({
  create: z.union([ z.lazy(() => SaleCreateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedCreateWithoutRefundsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SaleCreateOrConnectWithoutRefundsInputSchema).optional(),
  connect: z.lazy(() => SaleWhereUniqueInputSchema).optional(),
});

export const SaleUpdateOneRequiredWithoutRefundsNestedInputSchema: z.ZodType<Prisma.SaleUpdateOneRequiredWithoutRefundsNestedInput> = z.strictObject({
  create: z.union([ z.lazy(() => SaleCreateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedCreateWithoutRefundsInputSchema) ]).optional(),
  connectOrCreate: z.lazy(() => SaleCreateOrConnectWithoutRefundsInputSchema).optional(),
  upsert: z.lazy(() => SaleUpsertWithoutRefundsInputSchema).optional(),
  connect: z.lazy(() => SaleWhereUniqueInputSchema).optional(),
  update: z.union([ z.lazy(() => SaleUpdateToOneWithWhereWithoutRefundsInputSchema), z.lazy(() => SaleUpdateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedUpdateWithoutRefundsInputSchema) ]).optional(),
});
...
export const RefundCreateWithoutSaleInputSchema: z.ZodType<Prisma.RefundCreateWithoutSaleInput> = z.strictObject({
  id: z.uuid().optional(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  cashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const RefundUncheckedCreateWithoutSaleInputSchema: z.ZodType<Prisma.RefundUncheckedCreateWithoutSaleInput> = z.strictObject({
  id: z.uuid().optional(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  cashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const RefundCreateOrConnectWithoutSaleInputSchema: z.ZodType<Prisma.RefundCreateOrConnectWithoutSaleInput> = z.strictObject({
  where: z.lazy(() => RefundWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema) ]),
});

export const RefundCreateManySaleInputEnvelopeSchema: z.ZodType<Prisma.RefundCreateManySaleInputEnvelope> = z.strictObject({
  data: z.union([ z.lazy(() => RefundCreateManySaleInputSchema), z.lazy(() => RefundCreateManySaleInputSchema).array() ]),
  skipDuplicates: z.boolean().optional(),
});
...
export const RefundUpsertWithWhereUniqueWithoutSaleInputSchema: z.ZodType<Prisma.RefundUpsertWithWhereUniqueWithoutSaleInput> = z.strictObject({
  where: z.lazy(() => RefundWhereUniqueInputSchema),
  update: z.union([ z.lazy(() => RefundUpdateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedUpdateWithoutSaleInputSchema) ]),
  create: z.union([ z.lazy(() => RefundCreateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedCreateWithoutSaleInputSchema) ]),
});

export const RefundUpdateWithWhereUniqueWithoutSaleInputSchema: z.ZodType<Prisma.RefundUpdateWithWhereUniqueWithoutSaleInput> = z.strictObject({
  where: z.lazy(() => RefundWhereUniqueInputSchema),
  data: z.union([ z.lazy(() => RefundUpdateWithoutSaleInputSchema), z.lazy(() => RefundUncheckedUpdateWithoutSaleInputSchema) ]),
});

export const RefundUpdateManyWithWhereWithoutSaleInputSchema: z.ZodType<Prisma.RefundUpdateManyWithWhereWithoutSaleInput> = z.strictObject({
  where: z.lazy(() => RefundScalarWhereInputSchema),
  data: z.union([ z.lazy(() => RefundUpdateManyMutationInputSchema), z.lazy(() => RefundUncheckedUpdateManyWithoutSaleInputSchema) ]),
});

export const RefundScalarWhereInputSchema: z.ZodType<Prisma.RefundScalarWhereInput> = z.strictObject({
  AND: z.union([ z.lazy(() => RefundScalarWhereInputSchema), z.lazy(() => RefundScalarWhereInputSchema).array() ]).optional(),
  OR: z.lazy(() => RefundScalarWhereInputSchema).array().optional(),
  NOT: z.union([ z.lazy(() => RefundScalarWhereInputSchema), z.lazy(() => RefundScalarWhereInputSchema).array() ]).optional(),
  id: z.union([ z.lazy(() => UuidFilterSchema), z.string() ]).optional(),
  saleId: z.union([ z.lazy(() => UuidFilterSchema), z.string() ]).optional(),
  incrementStart: z.union([ z.lazy(() => IntFilterSchema), z.number() ]).optional(),
  cardAmount: z.union([ z.lazy(() => DecimalFilterSchema), z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }) ]).optional(),
...
export const SaleCreateWithoutRefundsInputSchema: z.ZodType<Prisma.SaleCreateWithoutRefundsInput> = z.strictObject({
  id: z.uuid().optional(),
  saleIndex: z.number().int(),
  incrementStart: z.number().int().optional(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const SaleUncheckedCreateWithoutRefundsInputSchema: z.ZodType<Prisma.SaleUncheckedCreateWithoutRefundsInput> = z.strictObject({
  id: z.uuid().optional(),
  buyerId: z.string(),
  saleIndex: z.number().int(),
  incrementStart: z.number().int().optional(),
...
export const SaleCreateOrConnectWithoutRefundsInputSchema: z.ZodType<Prisma.SaleCreateOrConnectWithoutRefundsInput> = z.strictObject({
  where: z.lazy(() => SaleWhereUniqueInputSchema),
  create: z.union([ z.lazy(() => SaleCreateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedCreateWithoutRefundsInputSchema) ]),
});

export const SaleUpsertWithoutRefundsInputSchema: z.ZodType<Prisma.SaleUpsertWithoutRefundsInput> = z.strictObject({
  update: z.union([ z.lazy(() => SaleUpdateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedUpdateWithoutRefundsInputSchema) ]),
  create: z.union([ z.lazy(() => SaleCreateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedCreateWithoutRefundsInputSchema) ]),
  where: z.lazy(() => SaleWhereInputSchema).optional(),
});

export const SaleUpdateToOneWithWhereWithoutRefundsInputSchema: z.ZodType<Prisma.SaleUpdateToOneWithWhereWithoutRefundsInput> = z.strictObject({
  where: z.lazy(() => SaleWhereInputSchema).optional(),
  data: z.union([ z.lazy(() => SaleUpdateWithoutRefundsInputSchema), z.lazy(() => SaleUncheckedUpdateWithoutRefundsInputSchema) ]),
});

export const SaleUpdateWithoutRefundsInputSchema: z.ZodType<Prisma.SaleUpdateWithoutRefundsInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  saleIndex: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const SaleUncheckedUpdateWithoutRefundsInputSchema: z.ZodType<Prisma.SaleUncheckedUpdateWithoutRefundsInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  buyerId: z.union([ z.string(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  saleIndex: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RefundCreateManySaleInputSchema: z.ZodType<Prisma.RefundCreateManySaleInput> = z.strictObject({
  id: z.uuid().optional(),
  incrementStart: z.number().int(),
  cardAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
  cashAmount: z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }).optional(),
...
export const RefundUpdateWithoutSaleInputSchema: z.ZodType<Prisma.RefundUpdateWithoutSaleInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  cashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RefundUncheckedUpdateWithoutSaleInputSchema: z.ZodType<Prisma.RefundUncheckedUpdateWithoutSaleInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  cashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const RefundUncheckedUpdateManyWithoutSaleInputSchema: z.ZodType<Prisma.RefundUncheckedUpdateManyWithoutSaleInput> = z.strictObject({
  id: z.union([ z.uuid(),z.lazy(() => StringFieldUpdateOperationsInputSchema) ]).optional(),
  incrementStart: z.union([ z.number().int(),z.lazy(() => IntFieldUpdateOperationsInputSchema) ]).optional(),
  cardAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
  cashAmount: z.union([ z.union([z.number(),z.string(),z.instanceof(Decimal),z.instanceof(Prisma.Decimal),DecimalJsLikeSchema,]).refine((v) => isValidDecimalInput(v), { message: 'Must be a Decimal' }),z.lazy(() => DecimalFieldUpdateOperationsInputSchema) ]).optional(),
...
export const CashRegisterControlFindFirstArgsSchema: z.ZodType<Prisma.CashRegisterControlFindFirstArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereInputSchema.optional(), 
  orderBy: z.union([ CashRegisterControlOrderByWithRelationInputSchema.array(), CashRegisterControlOrderByWithRelationInputSchema ]).optional(),
  cursor: CashRegisterControlWhereUniqueInputSchema.optional(), 
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ CashRegisterControlScalarFieldEnumSchema, CashRegisterControlScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export const CashRegisterControlFindFirstOrThrowArgsSchema: z.ZodType<Prisma.CashRegisterControlFindFirstOrThrowArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereInputSchema.optional(), 
  orderBy: z.union([ CashRegisterControlOrderByWithRelationInputSchema.array(), CashRegisterControlOrderByWithRelationInputSchema ]).optional(),
  cursor: CashRegisterControlWhereUniqueInputSchema.optional(), 
...
export const CashRegisterControlFindManyArgsSchema: z.ZodType<Prisma.CashRegisterControlFindManyArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereInputSchema.optional(), 
  orderBy: z.union([ CashRegisterControlOrderByWithRelationInputSchema.array(), CashRegisterControlOrderByWithRelationInputSchema ]).optional(),
  cursor: CashRegisterControlWhereUniqueInputSchema.optional(), 
...
export const CashRegisterControlAggregateArgsSchema: z.ZodType<Prisma.CashRegisterControlAggregateArgs> = z.object({
  where: CashRegisterControlWhereInputSchema.optional(), 
  orderBy: z.union([ CashRegisterControlOrderByWithRelationInputSchema.array(), CashRegisterControlOrderByWithRelationInputSchema ]).optional(),
  cursor: CashRegisterControlWhereUniqueInputSchema.optional(), 
  take: z.number().optional(),
...
export const CashRegisterControlGroupByArgsSchema: z.ZodType<Prisma.CashRegisterControlGroupByArgs> = z.object({
  where: CashRegisterControlWhereInputSchema.optional(), 
  orderBy: z.union([ CashRegisterControlOrderByWithAggregationInputSchema.array(), CashRegisterControlOrderByWithAggregationInputSchema ]).optional(),
  by: CashRegisterControlScalarFieldEnumSchema.array(), 
  having: CashRegisterControlScalarWhereWithAggregatesInputSchema.optional(), 
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict();

export const CashRegisterControlFindUniqueArgsSchema: z.ZodType<Prisma.CashRegisterControlFindUniqueArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereUniqueInputSchema, 
}).strict();

export const CashRegisterControlFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.CashRegisterControlFindUniqueOrThrowArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereUniqueInputSchema, 
}).strict();
...
export const RefundFindFirstArgsSchema: z.ZodType<Prisma.RefundFindFirstArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereInputSchema.optional(), 
  orderBy: z.union([ RefundOrderByWithRelationInputSchema.array(), RefundOrderByWithRelationInputSchema ]).optional(),
  cursor: RefundWhereUniqueInputSchema.optional(), 
  take: z.number().optional(),
  skip: z.number().optional(),
  distinct: z.union([ RefundScalarFieldEnumSchema, RefundScalarFieldEnumSchema.array() ]).optional(),
}).strict();

export const RefundFindFirstOrThrowArgsSchema: z.ZodType<Prisma.RefundFindFirstOrThrowArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereInputSchema.optional(), 
  orderBy: z.union([ RefundOrderByWithRelationInputSchema.array(), RefundOrderByWithRelationInputSchema ]).optional(),
...
export const RefundFindManyArgsSchema: z.ZodType<Prisma.RefundFindManyArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereInputSchema.optional(), 
  orderBy: z.union([ RefundOrderByWithRelationInputSchema.array(), RefundOrderByWithRelationInputSchema ]).optional(),
...
export const RefundAggregateArgsSchema: z.ZodType<Prisma.RefundAggregateArgs> = z.object({
  where: RefundWhereInputSchema.optional(), 
  orderBy: z.union([ RefundOrderByWithRelationInputSchema.array(), RefundOrderByWithRelationInputSchema ]).optional(),
  cursor: RefundWhereUniqueInputSchema.optional(), 
  take: z.number().optional(),
...
export const RefundGroupByArgsSchema: z.ZodType<Prisma.RefundGroupByArgs> = z.object({
  where: RefundWhereInputSchema.optional(), 
  orderBy: z.union([ RefundOrderByWithAggregationInputSchema.array(), RefundOrderByWithAggregationInputSchema ]).optional(),
  by: RefundScalarFieldEnumSchema.array(), 
  having: RefundScalarWhereWithAggregatesInputSchema.optional(), 
  take: z.number().optional(),
  skip: z.number().optional(),
}).strict();

export const RefundFindUniqueArgsSchema: z.ZodType<Prisma.RefundFindUniqueArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereUniqueInputSchema, 
}).strict();

export const RefundFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.RefundFindUniqueOrThrowArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereUniqueInputSchema, 
}).strict();
...
export const CashRegisterControlCreateArgsSchema: z.ZodType<Prisma.CashRegisterControlCreateArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  data: z.union([ CashRegisterControlCreateInputSchema, CashRegisterControlUncheckedCreateInputSchema ]),
}).strict();

export const CashRegisterControlUpsertArgsSchema: z.ZodType<Prisma.CashRegisterControlUpsertArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereUniqueInputSchema, 
  create: z.union([ CashRegisterControlCreateInputSchema, CashRegisterControlUncheckedCreateInputSchema ]),
  update: z.union([ CashRegisterControlUpdateInputSchema, CashRegisterControlUncheckedUpdateInputSchema ]),
}).strict();

export const CashRegisterControlCreateManyArgsSchema: z.ZodType<Prisma.CashRegisterControlCreateManyArgs> = z.object({
  data: z.union([ CashRegisterControlCreateManyInputSchema, CashRegisterControlCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const CashRegisterControlCreateManyAndReturnArgsSchema: z.ZodType<Prisma.CashRegisterControlCreateManyAndReturnArgs> = z.object({
  data: z.union([ CashRegisterControlCreateManyInputSchema, CashRegisterControlCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const CashRegisterControlDeleteArgsSchema: z.ZodType<Prisma.CashRegisterControlDeleteArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  where: CashRegisterControlWhereUniqueInputSchema, 
}).strict();

export const CashRegisterControlUpdateArgsSchema: z.ZodType<Prisma.CashRegisterControlUpdateArgs> = z.object({
  select: CashRegisterControlSelectSchema.optional(),
  data: z.union([ CashRegisterControlUpdateInputSchema, CashRegisterControlUncheckedUpdateInputSchema ]),
  where: CashRegisterControlWhereUniqueInputSchema, 
}).strict();

export const CashRegisterControlUpdateManyArgsSchema: z.ZodType<Prisma.CashRegisterControlUpdateManyArgs> = z.object({
  data: z.union([ CashRegisterControlUpdateManyMutationInputSchema, CashRegisterControlUncheckedUpdateManyInputSchema ]),
  where: CashRegisterControlWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const CashRegisterControlUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.CashRegisterControlUpdateManyAndReturnArgs> = z.object({
  data: z.union([ CashRegisterControlUpdateManyMutationInputSchema, CashRegisterControlUncheckedUpdateManyInputSchema ]),
  where: CashRegisterControlWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const CashRegisterControlDeleteManyArgsSchema: z.ZodType<Prisma.CashRegisterControlDeleteManyArgs> = z.object({
  where: CashRegisterControlWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();
...
export const RefundCreateArgsSchema: z.ZodType<Prisma.RefundCreateArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  data: z.union([ RefundCreateInputSchema, RefundUncheckedCreateInputSchema ]),
}).strict();

export const RefundUpsertArgsSchema: z.ZodType<Prisma.RefundUpsertArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereUniqueInputSchema, 
  create: z.union([ RefundCreateInputSchema, RefundUncheckedCreateInputSchema ]),
  update: z.union([ RefundUpdateInputSchema, RefundUncheckedUpdateInputSchema ]),
}).strict();

export const RefundCreateManyArgsSchema: z.ZodType<Prisma.RefundCreateManyArgs> = z.object({
  data: z.union([ RefundCreateManyInputSchema, RefundCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const RefundCreateManyAndReturnArgsSchema: z.ZodType<Prisma.RefundCreateManyAndReturnArgs> = z.object({
  data: z.union([ RefundCreateManyInputSchema, RefundCreateManyInputSchema.array() ]),
  skipDuplicates: z.boolean().optional(),
}).strict();

export const RefundDeleteArgsSchema: z.ZodType<Prisma.RefundDeleteArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  where: RefundWhereUniqueInputSchema, 
}).strict();

export const RefundUpdateArgsSchema: z.ZodType<Prisma.RefundUpdateArgs> = z.object({
  select: RefundSelectSchema.optional(),
  include: RefundIncludeSchema.optional(),
  data: z.union([ RefundUpdateInputSchema, RefundUncheckedUpdateInputSchema ]),
  where: RefundWhereUniqueInputSchema, 
}).strict();

export const RefundUpdateManyArgsSchema: z.ZodType<Prisma.RefundUpdateManyArgs> = z.object({
  data: z.union([ RefundUpdateManyMutationInputSchema, RefundUncheckedUpdateManyInputSchema ]),
  where: RefundWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const RefundUpdateManyAndReturnArgsSchema: z.ZodType<Prisma.RefundUpdateManyAndReturnArgs> = z.object({
  data: z.union([ RefundUpdateManyMutationInputSchema, RefundUncheckedUpdateManyInputSchema ]),
  where: RefundWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();

export const RefundDeleteManyArgsSchema: z.ZodType<Prisma.RefundDeleteManyArgs> = z.object({
  where: RefundWhereInputSchema.optional(), 
  limit: z.number().optional(),
}).strict();
